...
dataSet[dataSetVersion].characterData = [
  ...
  { name: "Fatal Death!Doctor/Koschei", opts: { series: [] } },
  // { name: "Fatal Death!Doctor/War Chief", opts: { series: [] } },
  { name: "Fatal Death!Doctor/Delgado", opts: { series: [] } },
  { name: "Fatal Death!Doctor/Crispy", opts: { series: [] } },
  { name: "Fatal Death!Doctor/Ainley", opts: { series: [] } },
  // { name: "Fatal Death!Doctor/Cheetah!Ainley", opts: { series: [] } },
  // { name: "Fatal Death!Doctor/Goosnake", opts: { series: [] } },
  { name: "Fatal Death!Doctor/Roberts", opts: { series: [] } },
  { name: "Fatal Death!Doctor/Macqueen", opts: { series: [] } },
  { name: "Fatal Death!Doctor/Jacobi", opts: { series: [] } },
  { name: "Fatal Death!Doctor/Simm", opts: { series: [] } },
  { name: "Fatal Death!Doctor/Missy", opts: { series: [] } },
  { name: "Fatal Death!Doctor/Lumiat", opts: { series: [] } },
  { name: "Fatal Death!Doctor/Dhawan", opts: { series: [] } },
  { name: "Fatal Death!Doctor/Shalka!Master", opts: { series: [] } },
  { name: "Fatal Death!Doctor/Fatal Death!Master", opts: { series: [] } },
